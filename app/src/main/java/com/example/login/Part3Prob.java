...
public class Part3Prob extends AppCompatActivity {
    ...
    private void updateCountDownText(){
        ...
        if(seconds == 20) {
         //   Toast.makeText(Part3Prob.this, "응답을 시작하세요!", Toast.LENGTH_SHORT).show();
         //   recordAudio();
        }
    }
    ...
    private void submitfile() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(Part3Prob.this, "업로드 실패", Toast.LENGTH_SHORT).show();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(Part3Prob.this, "업로드 성공", Toast.LENGTH_SHORT).show();
            }
        });
